  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, where your table reservation and menu management needs meet in one powerful, user-friendly platform."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, where your table reservation and menu management needs meet in one powerful, user-friendly platform.`}
            </Text>
            <Box
